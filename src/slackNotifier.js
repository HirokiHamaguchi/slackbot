...
dotenv.config({
    path: path.resolve('/home/hiroki/slackbot/.env')
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post(SLACK_WEBHOOK_URL, payload, {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Error sending Slack notification:", error_1);
                    return [3 /*break*/, 3];
